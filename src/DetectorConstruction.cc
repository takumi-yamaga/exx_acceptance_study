...
G4VPhysicalVolume* DetectorConstruction::Construct()
{
  ...
  auto cdh_solid 
    = new G4Box("cdh_solid",cdh_thickness,1.*cm,cdh_length);
  cdh_logical_
    = new G4LogicalVolume(cdh_solid,scintillator,"cdh_logical");
  G4VPVParameterisation* cdh_parametrization
    = new CDHParameterisation(cdh_number_of_segments,cdh_thickness,cdh_length);
  new G4PVParameterised("cdh_phsycial",cdh_logical_,
      world_logical,cdh_number_of_segments,cdh_parametrization,kCheckOverlaps);
  // ----------------------------------------------------------------
